...
const vec4 cons1 = vec4(0.098504, 0.098504, 0.098504, 1.000000);
const float cons2 = float(0.000000);
varying vec3 varnormal;
const vec4 cons6 = vec4(0.000000, 0.000000, 0.000000, 1.000000);
const float cons7 = float(0.000000);
...
void main()
{
	...
	node_output_material(tmp4, cons6, cons7, tmp8);
	linearrgb_to_srgb(tmp8, tmp10);
